...
save(list=ls(),file="clines_Lissotriton_R.rdat")
...
#     50%       5%      95% 
#0.3474654 0.3305234 0.3667171
quantile(oo$sdrc,probs=c(.5,.05,.95))
#      50%        5%       95% 
#0.1854921 0.1828221 0.1881061 
