...
save(list=ls(),file="clines_Lissotriton_L.rdat")
...
#     50%       5%      95% 
#0.3489292 0.3156337 0.3884736
quantile(oo$sdrc,probs=c(.5,.05,.95))
#      50%        5%       95% 
#0.08419853 0.07263155 0.09519566 
