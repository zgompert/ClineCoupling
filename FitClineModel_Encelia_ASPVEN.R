...
gdat<-fread("ASPVEN.miss0.5.ped",header=FALSE)
dim(gdat)
#[1] 104 218952
...
## wide distn. much better than PALVEN
...
save(list=ls(),file="clines_Encelia_ASPVEN.rdat")
...
#     50%       5%      95% 
#1.251220 1.095071 1.391342  
quantile(oo$sdrc,probs=c(.5,.05,.95))
#      50%        5%       95% 
#0.09083790 0.08530834 0.09655281  
